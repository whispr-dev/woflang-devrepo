// plugins/kanji_ops.cpp - Fixed Kanji operations plugin
...
class KanjiOpsPlugin : public WoflangPlugin {
public:
    void register_ops(WoflangInterpreter& interp) override {
        // Core kanji ops
        for (const auto& entry : basic_kanji) {
            interp.register_op(entry.kanji, [entry](WoflangInterpreter&) {
        ...
        interp.register_op("kanji_info", [](WoflangInterpreter& interp) {
...
WOFLANG_PLUGIN_EXPORT void register_plugin(woflang::WoflangInterpreter& interp) {
    static woflang::KanjiOpsPlugin plugin;
