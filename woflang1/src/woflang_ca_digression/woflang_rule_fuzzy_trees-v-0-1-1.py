...
sapling_growth_prob = 0.02  # Lower probability of sapling growing into a stunted tree
tree_decay_prob = 0.01     # Lower probability of stunted tree decaying back to empty
initial_sapling_prob = 0.5 # Initial probability of each cell starting as a sapling
