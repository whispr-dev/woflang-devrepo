...
STRING_TO_DOUBLE:
    ...
    ; Assumption: ESI points to the string buffer
    ; Output: XMM0 contains the double-precision float result
...
; Here, you may want to implement additional string-related operations that involve floating-point calculations.
