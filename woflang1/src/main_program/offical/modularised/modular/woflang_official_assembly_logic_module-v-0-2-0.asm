; Logic Module: loads all math functions as far as basic
; logical operations. must be kept this sm0l.
...
; Function Table
FUNC_ADD         EQU LOGIC_ADD_FUNC
FUNC_SUBTRACT    EQU LOGIC_SUBTRACT_FUNC
FUNC_MULTIPLY       EQU LOGIC_MUL_FUNC
FUNC_DIVIDE     EQU LOGIC_DIV_FUNC
FUNC_GREATER_THAN    EQU LOGIC_Greater_Than_FUNC
FUNC_LESS_THAN  EQU LOGIC_Less_Than_FUNC
FUNC_EQUALS     EQU MATH_LOGIC_Equals_FUNC
FUNC_DOESN'T_EQUAL   EQU LOGIC_Does_Not_Equal_FUNC
FUNC_GRETAER_THAN_OR_EQUAL   EQU LOGIC_Greater_than_Or_Equal_FUNC
LESS_THAN_OR_EQUAL  EQU LOGIC_Less_Than_Or_Equal_FUNC
