...
void init_plugin(woflang::WoflangInterpreter::OpTable* op_table) {
    ...
    (*op_table)["minor"] = [](std::stack<woflang::WofValue>& stack) {
        if (stack.empty()) {
        ...
        woflang::WofValue v1, v2, v3;
        v1.d = root_freq;
        v2.d = root_freq * 1.2;     // Minor third
        v3.d = root_freq * 1.5;     // Perfect fifth
